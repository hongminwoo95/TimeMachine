...
public class Future20Year extends PresentMe {
	...
	public void add() {
		...
		boolean flag = true;
		while (flag) {
			System.out.println("20년뒤 미래입니다 등록메뉴를 선택해주세요");
	...
	public void jobAdd() { // 직업등록
		System.out.println("20년후 직업을 등록해주세요");
		String job = s.nextLine();
		this.job=job;
	}
	public void workAdd() {
		System.out.println("20년후 하는일을 등록해주세요");
		String work = s.nextLine();
		this.work=work;
	}
	public void salary() {
		System.out.println("20년후 연봉을 등록해주세요");
	...
	public void prt() {
		...
		System.out.println("20년후 일 : "+work);
